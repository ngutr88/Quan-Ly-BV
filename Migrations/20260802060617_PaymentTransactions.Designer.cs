...
namespace QuanLyBenhVien.Migrations
{
    ...
    [Migration("20260802060617_PaymentTransactions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("DaGuiAutoReplyNgoaiGio")
                        .HasColumnType("INTEGER");

                    b.Property<string>("GhiChuKetLuan")
                        .HasMaxLength(1000)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTime?>("ThoiGianChoTraLoiTu")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("ThoiGianTinNhanCuoi")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("BenhNhanId", "BacSiId")
                        .IsUnique();

                    b.ToTable("HoiThoaiTuVan", t =>
                        {
                            t.HasCheckConstraint("CK_HoiThoaiTuVan_TrangThai", "TrangThai IN ('Moi','DangXuLy','DaTraLoi','DaDong')");
                        });
                });

            modelBuilder.Entity("QuanLyBenhVien.Models.ConversationMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<bool>("DaXemBoiNguoiNhan")
                        .HasColumnType("INTEGER");

                    b.Property<int>("HoiThoaiId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("VaiTroNguoiGui")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("HoiThoaiId", "ThoiGianGui");

                    b.HasIndex("HoiThoaiId", "VaiTroNguoiGui", "DaXemBoiNguoiNhan");

                    b.ToTable("TinNhanTuVan", t =>
                        {
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.ConversationMessageAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.Invoice", b =>
                {
                    ...
                    b.Property<int?>("GiaoDichThanhToanHienTaiId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("GiaoDichThanhToanHienTaiId");
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.PaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("MaGiaoDichCong")
                        .IsUnique()
                        .HasFilter("[MaGiaoDichCong] IS NOT NULL");

                    b.HasIndex("NguoiKhoiTaoId");

                    b.ToTable("GiaoDichThanhToan", t =>
                        {
                            t.HasCheckConstraint("CK_GiaoDichThanhToan_SoTien", "SoTien >= 0");

                            t.HasCheckConstraint("CK_GiaoDichThanhToan_TrangThai", "TrangThai IN ('ChoXuLy','DangXuLy','ThanhCong','ThatBai','DaHuy')");
                        });
                });
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.ProfileChangeRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.User", b =>
                {
                    ...
                    b.Property<bool>("DuocDuyetHoSoHanhNghe")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.ConversationMessage", b =>
                {
                    b.HasOne("QuanLyBenhVien.Models.Conversation", "HoiThoai")
                        .WithMany("TinNhan")
                        .HasForeignKey("HoiThoaiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QuanLyBenhVien.Models.User", "NguoiGui")
                        .WithMany()
                        .HasForeignKey("NguoiGuiId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("HoiThoai");
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.ConversationMessageAttachment", b =>
                {
                    b.HasOne("QuanLyBenhVien.Models.ConversationMessage", "TinNhan")
                        .WithMany("TepDinhKem")
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.Invoice", b =>
                {
                    b.HasOne("QuanLyBenhVien.Models.PaymentTransaction", "GiaoDichThanhToanHienTai")
                        .WithMany("Invoices")
                        .HasForeignKey("GiaoDichThanhToanHienTaiId");
                    ...
                    b.Navigation("GiaoDichThanhToanHienTai");
                });
            ...
            modelBuilder.Entity("QuanLyBenhVien.Models.PaymentTransaction", b =>
                {
                    b.HasOne("QuanLyBenhVien.Models.User", "NguoiKhoiTao")
                        .WithMany()
